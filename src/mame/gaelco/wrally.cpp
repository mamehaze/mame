...
static INPUT_PORTS_START( wrally )
	...
	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_CUSTOM) PORT_READ_LINE_MEMBER(FUNC(wrally_state::analog_bit_r<0>))
	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_CUSTOM) PORT_READ_LINE_MEMBER(FUNC(wrally_state::analog_bit_r<1>))
...
GAME( 1993, wrally,    0,      wrally, wrally, wrally_state, empty_init, ROT0, "Gaelco", "World Rally (version 1.0, checksum DE0D, 08 Nov 1993)", MACHINE_SUPPORTS_SAVE ) // date from labels
GAME( 1993, wrallya,   wrally, wrally, wrally, wrally_state, empty_init, ROT0, "Gaelco", "World Rally (version 1.0, checksum E586, 25 Jun 1993)", MACHINE_SUPPORTS_SAVE ) // date from labels, marked as "Japan"
GAME( 1993, wrallyb,   wrally, wrally, wrally, wrally_state, empty_init, ROT0, "Gaelco", "World Rally (version 1.0, checksum 8AA2)", MACHINE_SUPPORTS_SAVE ) // unknown date but has the additional censorship
...
GAME( 1993, wrallyata, wrally, wrally, wrally, wrally_state, empty_init, ROT0, "Gaelco (Atari license)", "World Rally (America, version 1.0, checksum 75A5, 16 Jun 1993)", MACHINE_SUPPORTS_SAVE ) // date from labels
