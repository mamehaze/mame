...
static INPUT_PORTS_START( bubltea )
	PORT_START("IN0")
...
// まぜまぜミックス！ぷにタピちゃん
CONS( 201?, bubltea,   0,        0, puni, bubltea, generalplus_gpl951xx_game_state, empty_init, "Bandai", "Mazemaze Mix! Puni Tapi-chan (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND)
