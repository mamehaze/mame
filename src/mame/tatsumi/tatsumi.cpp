...
void apache3_state::apache3_68000_map(address_map &map)
{
	...
	map(0x90000, 0x93fff).rw(m_spritegen, FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_r), FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_w));
	map(0x9a000, 0x9a1ff).rw(m_spritegen, FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_control_r), FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_control_w));
...
void cyclwarr_state::common_map(address_map &map)
{
	...
	map(0x0c0000, 0x0c3fff).rw(m_spritegen, FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_r), FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_w));

	map(0x0ca000, 0x0ca1ff).rw(m_spritegen, FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_control_r), FUNC(tatsumi_rot_sprite_deice::cyclwarr_sprite_control_w));
...
static GFXDECODE_START( gfx_apache3 )
	GFXDECODE_ENTRY( "spritegen:sprites", 0, spritelayout,    1024, 256)
...
static GFXDECODE_START( gfx_cyclwarr )
	GFXDECODE_ENTRY( "spritegen:sprites", 0, spritelayout,  8192, 512)
...
void apache3_state::apache3(machine_config &config)
{
	...
	m_spritegen->set_romtable_offset(0x800);
...
void cyclwarr_state::cyclwarr(machine_config &config)
{
	...
	m_spritegen->set_palette_tag("palette");
	m_spritegen->set_screen_tag("screen");
	m_spritegen->set_romtable_offset(0x1000);
...
ROM_START( apache3 )
	...
	ROM_REGION( 0x200000, "spritegen:sprites", ROMREGION_ERASE00 )
	/* Filled in by both regions below */

	ROM_REGION( 0x100000, "spritegen:sprites_l", 0)
	...
	ROM_REGION( 0x100000, "spritegen:sprites_h", 0)
...
ROM_START( roundup5 )
	...
	ROM_REGION( 0x180000, "spritegen:sprites", ROMREGION_ERASE00 )
	/* Filled in by both regions below */

	ROM_REGION( 0x0c0000, "spritegen:sprites_l", 0)
	...
	ROM_REGION( 0x0c0000, "spritegen:sprites_h", 0)
...
ROM_START( bigfight )
	...
	ROM_REGION( 0x400000, "spritegen:sprites", ROMREGION_ERASE00 )
	/* Filled in by both regions below */

	ROM_REGION( 0x200000, "spritegen:sprites_l", 0 )
	...
	ROM_REGION( 0x200000, "spritegen:sprites_h", 0 )
...
ROM_START( bigfightj ) // ABA-011 main board + ABA-012 daughter board
	...
	ROM_COPY("spritegen:sprites_l",          0x100000, 0x180000, 0x080000 )
	...
	ROM_COPY("spritegen:sprites_h",          0x100000, 0x180000, 0x080000 )
